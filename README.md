...
## How to Run
Download the directory and install `pygame`, `moviepy`, and Adafruit's [DHT library for CircuitPython](https://learn.adafruit.com/dht-humidity-sensing-on-raspberry-pi-with-gdocs-logging/python-setup). Run the programm with `python therm_variants.py`. 
